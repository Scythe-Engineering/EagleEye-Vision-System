...
- **Multi-select**: Hold **Shift** and drag on empty canvas space to draw a yellow marquee and select multiple operations; drag any selected node to move the group together
