...
def extract_frames_from_video(video_path: str, output_dir: str) -> None:
    ...
    pbar = tqdm(total=total_frames, unit="frame", desc="Extracting frames")
    ...
    while True:
        ...
        # Save the frame
        frame_filename = f"{frame_index:06d}.png"
...
def main() -> None:
    video_path = "input_video.mp4"  # Update this path as needed
