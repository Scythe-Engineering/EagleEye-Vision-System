...
def main():
    ...
    device = "auto"
    save_path = "E:/Ceph-Mirror/Python-Files/Projects/FIRST-Note-Detection/src/main_operations/modules/apriltags/pre_processing/ai_accelleration/training/detection_results.png"

    # Set default image path if not provided
    if image_path is None:
        default_image = "src/main_operations/modules/apriltags/pre_processing/ai_accelleration/training/training_data/frame_0636.png"
